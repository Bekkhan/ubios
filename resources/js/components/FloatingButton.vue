<template>
    <div class="position-fixed text-right floating-action-menu" style="bottom: 35px; right: 35px;">
        <div class="d-block action-button">
            <a target="_blank" href="https://wa.me/77003647617" class="btn btn-floating btn-success d-flex justify-content-center align-items-center" style="border-radius:45px; width: 70px; height: 70px">
